...
* Számos Open Geospatial Consortium (OGC) szabvány támogatása
  ...
  * :doc:`../standards/wms_overview` (kliens/szerver), :doc:`../standards/wfs_overview` (nem tranzakciós, kliens/szerver), WMC, |wcs_standards|, |fe_standards|, |sld_standards|, |gml_standards|, SOS, OM

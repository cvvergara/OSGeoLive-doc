...
pycsw is a `Python`_ implementation of the |csw_standards|. The CSW standard defines common interfaces to discover, browse and query metadata about spatial data, web services and related resources.

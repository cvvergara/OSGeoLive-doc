...
* Unterstützung zahlreicher Open Geospatial Consortium (OGC) Standards
  ...
  * :doc:`../standards/wms_overview` (Client/Server), :doc:`../standards/wfs_overview` (nicht-transaktional, Client/Server), WMC, :doc:`../standards/wcs_overview`, |fe_standards|, |sld_standards|, |gml_standards|, SOS, OM

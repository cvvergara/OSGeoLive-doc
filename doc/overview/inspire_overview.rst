...
The `Joint Research Centre (JRC) of the European Commission <https://joint-research-centre.ec.europa.eu/index_en>`__
develops and maintains a number of central software components, which help Member States in the INSPIRE implementation
process:

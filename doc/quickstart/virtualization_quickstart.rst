...
* Download `Virtual Box <https://www.virtualbox.org/>`_ for your platform, and
...
* **Spare**: Minimum 30 GB Hard Disk Space. The virtual disk file (vmdk) from
  :doc:`live.osgeo.org <../download>` unzips to |osgeolive-hdspace|. You'll
  also want more space to allow some room to work on the virtual machine. So a
  total of 30 GB is a good recommendation.
